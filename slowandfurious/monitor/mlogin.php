...
$stmt = $pdo->prepare('SELECT m_id, m_fname FROM monitors
where m_email=:em and m_password=:pw and m_status=1');
...
$_SESSION["fn"] = $row["m_fname"];

//to store the first name and client_id
$_SESSION["monitorid"] = $row["m_id"];
                        ...
                        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                            <div class="card shadow-2-strong" style="border-radius: 1rem">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <h3 class="mb-5">Monitors login</h3>

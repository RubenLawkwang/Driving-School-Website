...
?>
    ...
    <div class="container my-5">
        <div class="card-body">
            ...
            <form action="confirmerequest.php" method="GET">
                ...
                <button type="submit" name="dc_id" class="button" <?php echo htmlspecialchars($row['dc_id']); ?>
                    style="vertical-align: middle"><span>Accept Request</span></button>

            </form>
            <a href="viewclient.php?id=<?php echo urlencode($row['c_id']); ?>" class="btn btn-primary">View profile</a>
